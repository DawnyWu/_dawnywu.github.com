...
var GridBody = React.createClass({
  ...
  render: function() {
    ...
    rows.push((<tr id = "gridgridrecbottom" key={rows.length} line="bottom" style={
        {
    ...
    return (<table>
      <tbody>
        <tr line="0">
          <td className="w2ui-grid-data" col="0" style={
            {
              height: 0,
              width: 50,
            }
          }></td>
          <td className="w2ui-grid-data" col="1" style={
              {
                height: 0,
                width: 150,
              }
          ...
          <td className="w2ui-grid-data" col="2" style={
              {
                height: 0,
                width: 150,
              }
          ...
          <td className="w2ui-grid-data" col="3" style={
              {
                height: 0,
                width: 150,
              }
          ...
          <td className="w2ui-grid-data-last" style={
              {
                height: 0,
                width: 81
              }
...
var Grid = React.createClass({
  ...
  render: function() {
    return (<div id="grid" style={
        {
          width: 600,
          height: 568,
        }
      } name="grid" className="w2ui-reset w2ui-grid">
      <div style={{width: 598, height: 566,}}>
        <div id="gridgridheader" className="w2ui-grid-header" style={{display: 'none'}}></div>
        <GridToolbar/>
        <div id="gridgridbody" className="w2ui-grid-body" style={
          {
            top: 38,
            bottom: 24,
            left: 0,
          ...
          <div id="gridgridrecords" className="w2ui-grid-records" style={{
            ...
            ref="scrollable" onScroll={this.onScroll}>
...
var GridToolbar = React.createClass({
  ...
  render: function() {
    return (<div id="gridgridtoolbar"
      className="w2ui-grid-toolbar w2ui-reset w2ui-toolbar"
      name="gridtoolbar"
      style={
        {
          top: 0,
                      ...
                      <td>
                        <table cellPadding="1" cellSpacing="0">
                          <tbody>
                            <tr>
                              <td>
                                <div className="w2ui-tb-image w2ui-icon icon-reload"></div></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
                      ...
                      <td>
                        <table cellPadding="1" cellSpacing="0">
                          <tbody>
                            <tr>
                              <td>
                                <div className="w2ui-tb-image w2ui-icon icon-columns">
                                </div>
                              </td>
                            </tr>
                          </tbody>
              ...
              <td id="tbgridtoolbaritembreak0" valign="middle">
                <table cellPadding="0" cellSpacing="0">
                  <tbody>
                    <tr>
                      <td>
                        <div className="w2ui-break"> {String.fromCharCode(160)}
                        </div>
                      </td>
                    </tr>
                  </tbody>
                      ...
                      <td nowrap="nowrap">
                        <table cellPadding="0" cellSpacing="0">
                          <tbody>
                            <tr>
                              <td>
                                <div className="w2ui-icon icon-search-down w2ui-search-down"
                                  title = "Select Search Field">
                                </div>
                              </td>
                              <td>
                                <input id="gridgridsearchall" className="w2ui-search-all"
                                  placeholder = "All Fields"/>
                              </td>
                            <td>
                              <div title="Clear Search" className="w2ui-search-clear" id="gridgridsearchClear"
                                style = {
                                  {display: 'none'}
                      ...
                      <table cellPadding="1" cellSpacing="0">
                        <tbody>
                          <tr>
                            ...
                            <td className="w2ui-tb-caption" nowrap="nowrap">
                              Search...
                            </td>
                          </tr>
                        </tbody>
